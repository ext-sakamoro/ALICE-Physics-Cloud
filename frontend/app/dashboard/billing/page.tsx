...
const plans = [
  { name: 'Free', price: '$0/mo', features: ['100 simulations/day', 'Rigid body only', '1 world', 'Community support'] },
  { name: 'Pro', price: '$249/mo', features: ['Unlimited simulations', 'Rigid + soft body + fluid + cloth', 'Multi-world (100)', 'Collision detection + raycasting', 'Constraint solver', 'Priority support'] },
  { name: 'Enterprise', price: 'Custom', features: ['Unlimited everything', 'GPU-accelerated physics', 'Digital twin integration', 'Custom constraints', 'SLA 99.99%', 'Dedicated support'] },
];
